...
public class PokerLogic {
    ...
    public PokerLogic() throws TooFewCardsException, TooManyCardsException {
    }


    public static boolean comparHands(Hand playerHand, Hand opponentHand) throws TooFewCardsException, TooManyCardsException {

        int result = HandRank.compareHands(playerHand, opponentHand, 2);
        if (result == 0) {
            return true;
        } else {
            return false;
